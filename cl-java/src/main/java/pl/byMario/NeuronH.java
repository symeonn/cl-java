 ...
 */
public class NeuronH extends NeuronDto {

	public NeuronH(List<Double> input, long neuronId) {
		super(input, neuronId);

//		System.out.println("CREATE nH, input " + inputList.toString()+ "; waga " + weightList.toString());

		// this.inputList = input;
//		 process();
	}

	public NeuronH( long neuronId) {
		super(neuronId);
